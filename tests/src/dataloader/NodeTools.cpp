...
TEST_CASE("NodeTools expect list functions", "[NodeTools][NodeTools-expect-functions][NodeTools-expect-list-functions]") {
	...
	CHECK(expect_list_and_length(default_length_callback, std::bind_front(callback, _0_id_list, 0))(_0_id_list));
	CHECK(expect_list_and_length(default_length_callback, std::bind_front(callback, _0_str_list, 0))(_0_str_list));
	CHECK(expect_list_and_length(default_length_callback, std::bind_front(callback, _3_id_list, 3))(_3_id_list));
	CHECK(expect_list_and_length(default_length_callback, std::bind_front(callback, _3_str_list, 3))(_3_str_list));
	CHECK(expect_list_and_length(default_length_callback, std::bind_front(callback, _4_id_list, 4))(_4_id_list));
	CHECK(expect_list_and_length(default_length_callback, std::bind_front(callback, _4_str_list, 4))(_4_str_list));
	CHECK(expect_list_and_length(default_length_callback, std::bind_front(callback, _10_id_list, 10))(_10_id_list));
	CHECK(expect_list_and_length(default_length_callback, std::bind_front(callback, _10_str_list, 10))(_10_str_list));
	CHECK(expect_list_and_length(default_length_callback, std::bind_front(callback, _24_id_list, 24))(_24_id_list));
	CHECK(expect_list_and_length(default_length_callback, std::bind_front(callback, _24_str_list, 24))(_24_str_list));

	CHECK(expect_list_and_length([](size_t) -> size_t { return 1;}, std::bind_front(callback, _24_str_list, 24))(_24_str_list));
	CHECK(expect_list_and_length([](size_t) -> size_t { return 24;}, std::bind_front(callback, _24_str_list, 24))(_24_str_list));
	CHECK_FALSE(expect_list_and_length([](size_t) -> size_t { return 25;}, std::bind_front(callback, _24_str_list, 24))(_24_str_list));

	CHECK(expect_list_of_length(0, std::bind_front(callback, _0_id_list, 0))(_0_id_list));
	CHECK(expect_list_of_length(0, std::bind_front(callback, _0_str_list, 0))(_0_str_list));
	CHECK(expect_list_of_length(3, std::bind_front(callback, _3_id_list, 3))(_3_id_list));
	CHECK(expect_list_of_length(3, std::bind_front(callback, _3_str_list, 3))(_3_str_list));
	CHECK(expect_list_of_length(4, std::bind_front(callback, _4_id_list, 4))(_4_id_list));
	CHECK(expect_list_of_length(4, std::bind_front(callback, _4_str_list, 4))(_4_str_list));
	CHECK(expect_list_of_length(10, std::bind_front(callback, _10_id_list, 10))(_10_id_list));
	CHECK(expect_list_of_length(10, std::bind_front(callback, _10_str_list, 10))(_10_str_list));
	CHECK(expect_list_of_length(24, std::bind_front(callback, _24_id_list, 24))(_24_id_list));
	CHECK(expect_list_of_length(24, std::bind_front(callback, _24_str_list, 24))(_24_str_list));

	CHECK_FALSE(expect_list_of_length(25, std::bind_front(callback, _24_id_list, 24))(_24_id_list));
	CHECK_FALSE(expect_list_of_length(25, std::bind_front(callback, _24_str_list, 24))(_24_str_list));

	CHECK_FALSE(expect_list_of_length(23, std::bind_front(callback, _24_id_list, 24))(_24_id_list));
	CHECK_FALSE(expect_list_of_length(23, std::bind_front(callback, _24_str_list, 24))(_24_str_list));

	CHECK(expect_list(std::bind_front(callback, _0_id_list, 0))(_0_id_list));
	CHECK(expect_list(std::bind_front(callback, _0_str_list, 0))(_0_str_list));
	CHECK(expect_list(std::bind_front(callback, _3_id_list, 3))(_3_id_list));
	CHECK(expect_list(std::bind_front(callback, _3_str_list, 3))(_3_str_list));
	CHECK(expect_list(std::bind_front(callback, _4_id_list, 4))(_4_id_list));
	CHECK(expect_list(std::bind_front(callback, _4_str_list, 4))(_4_str_list));
	CHECK(expect_list(std::bind_front(callback, _10_id_list, 10))(_10_id_list));
	CHECK(expect_list(std::bind_front(callback, _10_str_list, 10))(_10_str_list));
	CHECK(expect_list(std::bind_front(callback, _24_id_list, 24))(_24_id_list));
	CHECK(expect_list(std::bind_front(callback, _24_str_list, 24))(_24_str_list));
}
...
TEST_CASE("NodeTools expect key functions", "[NodeTools][NodeTools-expect-functions][NodeTools-expect-key-functions]") {
	...
	auto callback = [](ListValue const* ptr, NodeCPtr val) -> bool {
	...
	auto build_list = [&ast](size_t count, auto&& factory) -> ListValue* {
		StatementList slist;
		for (size_t index : ranges::views::iota(static_cast<size_t>(0), count)) {
			std::to_chars_result result = std::to_chars(hex_array.data(), hex_array.data() + hex_array.size(), index);
			CHECK_OR_CONTINUE(result.ec == std::errc {});
	...
	auto callback_dup = [](ListValue const* ptr, NodeCPtr val) -> bool {
		auto* flat_val = dryad::node_cast<FlatValue>(val);
		std::string_view val_sv = flat_val->value().view();
		CAPTURE(val_sv);
