...
struct Ast : ovdl::SymbolIntern {
	dryad::tree<ovdl::v2script::ast::FileTree> tree;
	dryad::node_map<const ovdl::v2script::ast::Node, ovdl::NodeLocation> map;
	...
	void set_location(ovdl::v2script::ast::Node const* n, ovdl::NodeLocation loc) {
		map.insert(n, loc);
	}

	ovdl::NodeLocation location_of(ovdl::v2script::ast::Node const* n) const {
	...
	template<typename T = ovdl::v2script::ast::IdentifierValue>
	inline auto create_value_statement_factory() {
		return [this](std::string_view sv) {
			return create<ovdl::v2script::ast::ValueStatement>(create_with_intern<T>(sv));
		};
	}
	...
	inline auto create_assign_statement_factory(std::string_view lhs, std::string_view rhs) {
		return [this, lhs, rhs]() {
			return create<ovdl::v2script::ast::AssignStatement>(create_with_intern<LeftT>(lhs), create_with_intern<RightT>(rhs));
		};
	}

	template<typename RightT = ovdl::v2script::ast::IdentifierValue>
	inline auto create_assign_statement_factory(std::string_view lhs, std::string_view rhs) {
		return create_assign_statement_factory<ovdl::v2script::ast::IdentifierValue, RightT>(lhs, rhs);
	}
	...
	inline ovdl::v2script::ast::ListValue* create_value_list_fill(size_t count, auto&& factory) {
		ovdl::v2script::ast::StatementList slist;
		for (size_t index = 0; index < count; index++) {
			slist.push_back(factory());
		}
		return create<ovdl::v2script::ast::ListValue>(slist);
	}

	inline ovdl::v2script::ast::ListValue* create_value_list(auto&&... factories) {
		ovdl::v2script::ast::StatementList slist;
		(slist.push_back(factories()), ...);
		return create<ovdl::v2script::ast::ListValue>(slist);
	}

	inline ovdl::v2script::ast::ListValue* create_assign_list(std::span<const std::string_view> span, auto&& factory) {
		ovdl::v2script::ast::StatementList slist;
	...
	template<typename T = ovdl::v2script::ast::IdentifierValue>
	inline ovdl::v2script::ast::ListValue* create_assign_list(std::span<const std::string_view> span_lhs, std::span<std::string_view> span_rhs) {
		ovdl::v2script::ast::StatementList slist;
	...
	inline ovdl::v2script::ast::ListValue* create_assign_list(size_t count, auto&& factory) {
	...
	template<typename T = ovdl::v2script::ast::IdentifierValue>
	inline ovdl::v2script::ast::ListValue* create_assign_list(size_t count, std::span<std::string_view> span_rhs) {
		static constexpr size_t bits_per_digit = 4;
		static constexpr size_t array_length = sizeof(size_t) * CHAR_BIT / bits_per_digit * 4;
		thread_local std::array<char, array_length> hex_array {};
...
TEST_CASE("NodeTools Default Callback functions", "[NodeTools][NodeTools-default-callback-functions]") {
	dryad::tree<ovdl::v2script::ast::Node> tree;
	ovdl::v2script::ast::Node* null_value = tree.create<ovdl::v2script::ast::NullValue>();
...
TEST_CASE("NodeTools expect string functions", "[NodeTools][NodeTools-expect-functions][NodeTools-expect-string-functions]") {
	Ast ast;
	auto* id = ast.create_with_intern<ovdl::v2script::ast::IdentifierValue>("expect"sv);
	auto* str = ast.create_with_intern<ovdl::v2script::ast::StringValue>("expect"sv);

	Callback<std::string_view> auto string_view_callback = [](std::string_view sv) -> bool {
...
TEST_CASE("NodeTools expect bool functions", "[NodeTools][NodeTools-expect-functions][NodeTools-expect-bool-functions]") {
	...
	auto* yes_id = ast.create_with_intern<ovdl::v2script::ast::IdentifierValue>("yes"sv);
	auto* yes_str = ast.create_with_intern<ovdl::v2script::ast::StringValue>("yes"sv);
	auto* no_id = ast.create_with_intern<ovdl::v2script::ast::IdentifierValue>("no"sv);
	auto* no_str = ast.create_with_intern<ovdl::v2script::ast::StringValue>("no"sv);

	auto* _2_id = ast.create_with_intern<ovdl::v2script::ast::IdentifierValue>("2"sv);
	auto* _2_str = ast.create_with_intern<ovdl::v2script::ast::StringValue>("2"sv);
	auto* _1_id = ast.create_with_intern<ovdl::v2script::ast::IdentifierValue>("1"sv);
	auto* _1_str = ast.create_with_intern<ovdl::v2script::ast::StringValue>("1"sv);
	auto* _0_id = ast.create_with_intern<ovdl::v2script::ast::IdentifierValue>("0"sv);
	auto* _0_str = ast.create_with_intern<ovdl::v2script::ast::StringValue>("0"sv);

	Callback<bool> auto bool_callback = [](bool val) -> bool {
		return val;
	};
...
TEST_CASE("NodeTools expect integer functions", "[NodeTools][NodeTools-expect-functions][NodeTools-expect-integer-functions]") {
	...
	auto* _2002_id = ast.create_with_intern<ovdl::v2script::ast::IdentifierValue>("2002"sv);
	auto* _2002_str = ast.create_with_intern<ovdl::v2script::ast::StringValue>("2002"sv);
	auto* _1001_id = ast.create_with_intern<ovdl::v2script::ast::IdentifierValue>("1001"sv);
	auto* _1001_str = ast.create_with_intern<ovdl::v2script::ast::StringValue>("1001"sv);

	auto* _max_long_id = ast.create_with_intern<ovdl::v2script::ast::IdentifierValue>("9223372036854775807"sv);
	auto* _max_long_str = ast.create_with_intern<ovdl::v2script::ast::StringValue>("9223372036854775807"sv);
	auto* _max_ulong_id = ast.create_with_intern<ovdl::v2script::ast::IdentifierValue>("18446744073709551615"sv);
	auto* _max_ulong_str = ast.create_with_intern<ovdl::v2script::ast::StringValue>("18446744073709551615"sv);
	auto* _min_long_id = ast.create_with_intern<ovdl::v2script::ast::IdentifierValue>("-9223372036854775808"sv);
	auto* _min_long_str = ast.create_with_intern<ovdl::v2script::ast::StringValue>("-9223372036854775808"sv);

	auto callback = [](ovdl::v2script::ast::FlatValue const* ptr, auto val) -> bool {
	...
	auto base_callback = [](ovdl::v2script::ast::FlatValue const* ptr, int base, auto val) -> bool {
		std::string_view sv = ptr->value().view();
	...
	auto* _binary_id = ast.create_with_intern<ovdl::v2script::ast::IdentifierValue>("0110"sv);
	auto* _binary_str = ast.create_with_intern<ovdl::v2script::ast::StringValue>("0110"sv);
	...
	auto* _octal_id = ast.create_with_intern<ovdl::v2script::ast::IdentifierValue>("2674"sv);
	auto* _octal_str = ast.create_with_intern<ovdl::v2script::ast::StringValue>("2674"sv);
	...
	SECTION("Detect Octal Base") {
		auto* _detect_octal_id = ast.create_with_intern<ovdl::v2script::ast::IdentifierValue>("02674"sv);
		auto* _detect_octal_str = ast.create_with_intern<ovdl::v2script::ast::StringValue>("02674"sv);
	...
	auto* _hex_id = ast.create_with_intern<ovdl::v2script::ast::IdentifierValue>("0xff2e5"sv);
	auto* _hex_str = ast.create_with_intern<ovdl::v2script::ast::StringValue>("0xff2e5"sv);
...
TEST_CASE(
	...
	auto* _0_01_id = ast.create_with_intern<ovdl::v2script::ast::IdentifierValue>("0.01"sv);
	auto* _0_01_str = ast.create_with_intern<ovdl::v2script::ast::StringValue>("0.01"sv);
	auto* _2_21_id = ast.create_with_intern<ovdl::v2script::ast::IdentifierValue>("2.21"sv);
	auto* _2_21_str = ast.create_with_intern<ovdl::v2script::ast::StringValue>("2.21"sv);
	auto* _303_id = ast.create_with_intern<ovdl::v2script::ast::IdentifierValue>("303"sv);
	auto* _303_str = ast.create_with_intern<ovdl::v2script::ast::StringValue>("303"sv);

	auto callback = [](ovdl::v2script::ast::FlatValue const* ptr, fixed_point_t val) -> bool {
		std::string_view sv = ptr->value().view();
...
TEST_CASE("NodeTools expect colour functions", "[NodeTools][NodeTools-expect-functions][NodeTools-expect-colour-functions]") {
	...
	auto callback = [](ovdl::v2script::ast::ListValue const* ptr, colour_t val) -> bool {
		...
		for (auto [index, sub_node] : list | ranges::views::enumerate) {
			if (auto const* value = dryad::node_try_cast<ovdl::v2script::ast::ValueStatement>(sub_node)) {
				if (auto const* id = dryad::node_try_cast<ovdl::v2script::ast::IdentifierValue>(value->value())) {
...
TEST_CASE(
	...
	auto* orange_id = ast.create_with_intern<ovdl::v2script::ast::IdentifierValue>("0xFFBB55"sv);
	auto* orange_str = ast.create_with_intern<ovdl::v2script::ast::StringValue>("0xFFBB55"sv);

	auto callback = [](ovdl::v2script::ast::FlatValue const* ptr, colour_argb_t val) -> bool {
		std::string_view sv = ptr->value().view();
...
TEST_CASE(
	...
	auto* left_id = ast.create_with_intern<ovdl::v2script::ast::IdentifierValue>("left"sv);
	auto* left_str = ast.create_with_intern<ovdl::v2script::ast::StringValue>("left"sv);
	auto* right_id = ast.create_with_intern<ovdl::v2script::ast::IdentifierValue>("right"sv);
	auto* right_str = ast.create_with_intern<ovdl::v2script::ast::StringValue>("right"sv);
	auto* centre_id = ast.create_with_intern<ovdl::v2script::ast::IdentifierValue>("centre"sv);
	auto* centre_str = ast.create_with_intern<ovdl::v2script::ast::StringValue>("centre"sv);
	auto* center_id = ast.create_with_intern<ovdl::v2script::ast::IdentifierValue>("center"sv);
	auto* center_str = ast.create_with_intern<ovdl::v2script::ast::StringValue>("center"sv);
	auto* justified_id = ast.create_with_intern<ovdl::v2script::ast::IdentifierValue>("justified"sv);
	auto* justified_str = ast.create_with_intern<ovdl::v2script::ast::StringValue>("justified"sv);

	auto callback = [](ovdl::v2script::ast::FlatValue const* ptr, text_format_t val) -> bool {
...
TEST_CASE("NodeTools expect Date functions", "[NodeTools][NodeTools-expect-functions][NodeTools-expect-date-functions]") {
	...
	auto* date_id = ast.create_with_intern<ovdl::v2script::ast::IdentifierValue>("1.1.1"sv);
	auto* date_str = ast.create_with_intern<ovdl::v2script::ast::StringValue>("1.1.1"sv);
	...
	auto callback = [](ovdl::v2script::ast::FlatValue const* ptr, Date val) -> bool {
		std::string_view sv = ptr->value().view();
...
TEST_CASE(
	...
	auto* _5_id = ast.create_with_intern<ovdl::v2script::ast::IdentifierValue>("5"sv);
	auto* _5_str = ast.create_with_intern<ovdl::v2script::ast::StringValue>("5"sv);

	enum class TimespanType : uint8_t { Day, Month, Year };
	auto callback = [](ovdl::v2script::ast::FlatValue const* ptr, TimespanType type, Timespan val) -> bool {
		std::string_view sv = ptr->value().view();
...
TEST_CASE("NodeTools expect vector functions", "[NodeTools][NodeTools-expect-functions][NodeTools-expect-vector-functions]") {
	...
	auto _0_str_assign = ast.create_assign_statement_rhs_factory<ovdl::v2script::ast::StringValue>("0"sv);
	auto _0_5_id_assign = ast.create_assign_statement_rhs_factory("0.5"sv);
	auto _0_5_str_assign = ast.create_assign_statement_rhs_factory<ovdl::v2script::ast::StringValue>("0.5"sv);
	auto _1_id_assign = ast.create_assign_statement_rhs_factory("1"sv);
	auto _1_str_assign = ast.create_assign_statement_rhs_factory<ovdl::v2script::ast::StringValue>("1"sv);
	auto _127_id_assign = ast.create_assign_statement_rhs_factory("127"sv);
	auto _127_str_assign = ast.create_assign_statement_rhs_factory<ovdl::v2script::ast::StringValue>("127"sv);
	auto _255_id_assign = ast.create_assign_statement_rhs_factory("255"sv);
	auto _255_str_assign = ast.create_assign_statement_rhs_factory<ovdl::v2script::ast::StringValue>("255"sv);

	static auto callback = [](ovdl::v2script::ast::ListValue const* ptr, auto val) -> bool {
		auto list = ptr->statements();
		...
		for (auto [index, statement] : list | ranges::views::enumerate) {
			...
			if (auto* assign = dryad::node_try_cast<ovdl::v2script::ast::AssignStatement>(statement)) {
				auto* lhs = dryad::node_cast<ovdl::v2script::ast::FlatValue>(assign->left());
				auto* rhs = dryad::node_cast<ovdl::v2script::ast::FlatValue>(assign->right());
				sv = rhs->value().view();
				...
				auto* value = dryad::node_cast<ovdl::v2script::ast::ValueStatement>(statement);
				auto* flat_value = dryad::node_cast<ovdl::v2script::ast::FlatValue>(value->value());
	...
	ovdl::v2script::ast::ListValue* _0_id_2_list = ast.create_assign_list(xy, _0_id_assign);
	ovdl::v2script::ast::ListValue* _0_str_2_list = ast.create_assign_list(xy, _0_str_assign);
	ovdl::v2script::ast::ListValue* _0_5_id_2_list = ast.create_assign_list(xy, _0_5_id_assign);
	ovdl::v2script::ast::ListValue* _0_5_str_2_list = ast.create_assign_list(xy, _0_5_str_assign);
	ovdl::v2script::ast::ListValue* _1_id_2_list = ast.create_assign_list(xy, _1_id_assign);
	ovdl::v2script::ast::ListValue* _1_str_2_list = ast.create_assign_list(xy, _1_str_assign);
	ovdl::v2script::ast::ListValue* _127_id_2_list = ast.create_assign_list(xy, _127_id_assign);
	ovdl::v2script::ast::ListValue* _127_str_2_list = ast.create_assign_list(xy, _127_str_assign);
	ovdl::v2script::ast::ListValue* _255_id_2_list = ast.create_assign_list(xy, _255_id_assign);
	ovdl::v2script::ast::ListValue* _255_str_2_list = ast.create_assign_list(xy, _255_str_assign);
	...
	auto _0_str = ast.create_value_statement_factory<ovdl::v2script::ast::StringValue>("0"sv);
	auto _0_5_id = ast.create_value_statement_factory("0.5"sv);
	auto _0_5_str = ast.create_value_statement_factory<ovdl::v2script::ast::StringValue>("0.5"sv);
	auto _1_id = ast.create_value_statement_factory("1"sv);
	auto _1_str = ast.create_value_statement_factory<ovdl::v2script::ast::StringValue>("1"sv);
	auto _127_id = ast.create_value_statement_factory("127"sv);
	auto _127_str = ast.create_value_statement_factory<ovdl::v2script::ast::StringValue>("127"sv);
	auto _255_id = ast.create_value_statement_factory("255"sv);
	auto _255_str = ast.create_value_statement_factory<ovdl::v2script::ast::StringValue>("255"sv);

	ovdl::v2script::ast::ListValue* _0_id_3_list = ast.create_value_list_fill(3, _0_id);
	ovdl::v2script::ast::ListValue* _0_str_3_list = ast.create_value_list_fill(3, _0_str);
	ovdl::v2script::ast::ListValue* _0_5_id_3_list = ast.create_value_list_fill(3, _0_5_id);
	ovdl::v2script::ast::ListValue* _0_5_str_3_list = ast.create_value_list_fill(3, _0_5_str);
	ovdl::v2script::ast::ListValue* _1_id_3_list = ast.create_value_list_fill(3, _1_id);
	ovdl::v2script::ast::ListValue* _1_str_3_list = ast.create_value_list_fill(3, _1_str);
	ovdl::v2script::ast::ListValue* _127_id_3_list = ast.create_value_list_fill(3, _127_id);
	ovdl::v2script::ast::ListValue* _127_str_3_list = ast.create_value_list_fill(3, _127_str);
	ovdl::v2script::ast::ListValue* _255_id_3_list = ast.create_value_list_fill(3, _255_id);
	ovdl::v2script::ast::ListValue* _255_str_3_list = ast.create_value_list_fill(3, _255_str);
	...
	ovdl::v2script::ast::ListValue* _0_id_4_list = ast.create_value_list_fill(4, _0_id);
	ovdl::v2script::ast::ListValue* _0_str_4_list = ast.create_value_list_fill(4, _0_str);
	ovdl::v2script::ast::ListValue* _0_5_id_4_list = ast.create_value_list_fill(4, _0_5_id);
	ovdl::v2script::ast::ListValue* _0_5_str_4_list = ast.create_value_list_fill(4, _0_5_str);
	ovdl::v2script::ast::ListValue* _1_id_4_list = ast.create_value_list_fill(4, _1_id);
	ovdl::v2script::ast::ListValue* _1_str_4_list = ast.create_value_list_fill(4, _1_str);
	ovdl::v2script::ast::ListValue* _127_id_4_list = ast.create_value_list_fill(4, _127_id);
	ovdl::v2script::ast::ListValue* _127_str_4_list = ast.create_value_list_fill(4, _127_str);
	ovdl::v2script::ast::ListValue* _255_id_4_list = ast.create_value_list_fill(4, _255_id);
	ovdl::v2script::ast::ListValue* _255_str_4_list = ast.create_value_list_fill(4, _255_str);
...
TEST_CASE("NodeTools expect assign functions", "[NodeTools][NodeTools-expect-functions][NodeTools-expect-assign-functions]") {
	...
	auto* str = ast.create_assign_statement_rhs_factory<ovdl::v2script::ast::StringValue>("right"sv)("left"sv);

	auto callback = [](ovdl::v2script::ast::AssignStatement const* ptr, std::string_view lhs, ovdl::v2script::ast::Node const* rhs) -> bool {
		auto* ptr_lhs = dryad::node_cast<ovdl::v2script::ast::FlatValue>(ptr->left());
		auto* ptr_rhs = dryad::node_cast<ovdl::v2script::ast::FlatValue>(ptr->right());

		auto* value = dryad::node_cast<ovdl::v2script::ast::FlatValue>(rhs);
...
TEST_CASE("NodeTools expect list functions", "[NodeTools][NodeTools-expect-functions][NodeTools-expect-list-functions]") {
	...
	auto str_value = ast.create_value_statement_factory<ovdl::v2script::ast::StringValue>();
	...
	static auto callback = [](ovdl::v2script::ast::ListValue const* ptr, size_t count, ovdl::v2script::ast::Node const* val) -> bool {
		auto list = ptr->statements();
		...
		for (auto [index, statement] : list | ranges::views::enumerate) {
			auto* check_value = dryad::node_cast<ovdl::v2script::ast::ValueStatement>(statement);

			auto* flat_value = dryad::node_cast<ovdl::v2script::ast::FlatValue>(val);

			auto* check_flat_value = dryad::node_cast<ovdl::v2script::ast::FlatValue>(check_value->value());
...
TEST_CASE("NodeTools expect length functions", "[NodeTools][NodeTools-expect-functions][NodeTools-expect-length-functions]") {
	...
	static auto callback = [](ovdl::v2script::ast::ListValue const* ptr, size_t count, size_t val) -> bool {
		auto list = ptr->statements();
		CHECK_IF(ranges::distance(list) == count);
		else {
			return false;
	...
	static auto callback_false = [](ovdl::v2script::ast::ListValue const* ptr, size_t count, size_t val) -> bool {
		auto list = ptr->statements();
...
TEST_CASE("NodeTools expect key functions", "[NodeTools][NodeTools-expect-functions][NodeTools-expect-key-functions]") {
	...
	static auto callback = [](ovdl::v2script::ast::ListValue const* ptr, ovdl::v2script::ast::Node const* val) -> bool {
		auto* flat_val = dryad::node_cast<ovdl::v2script::ast::FlatValue>(val);
		...
		for (auto [index, statement] : list | ranges::views::enumerate) {
			auto* assign = dryad::node_cast<ovdl::v2script::ast::AssignStatement>(statement);
			auto* lhs = dryad::node_cast<ovdl::v2script::ast::FlatValue>(assign->left());
			auto* rhs = dryad::node_cast<ovdl::v2script::ast::FlatValue>(assign->right());
	...
	ovdl::v2script::ast::ListValue* _0_id_list = ast.create_assign_list(8, _0_id_assign);
	ovdl::v2script::ast::ListValue* _0_str_list = ast.create_assign_list(8, _0_str_assign);
	ovdl::v2script::ast::ListValue* _0_5_id_list = ast.create_assign_list(7, _0_5_id_assign);
	ovdl::v2script::ast::ListValue* _0_5_str_list = ast.create_assign_list(7, _0_5_str_assign);
	ovdl::v2script::ast::ListValue* _1_id_list = ast.create_assign_list(6, _1_id_assign);
	ovdl::v2script::ast::ListValue* _1_str_list = ast.create_assign_list(6, _1_str_assign);
	ovdl::v2script::ast::ListValue* _127_id_list = ast.create_assign_list(5, _127_id_assign);
	ovdl::v2script::ast::ListValue* _127_str_list = ast.create_assign_list(5, _127_str_assign);
	ovdl::v2script::ast::ListValue* _255_id_list = ast.create_assign_list(4, _255_id_assign);
	ovdl::v2script::ast::ListValue* _255_str_list = ast.create_assign_list(4, _255_str_assign);
	...
	static auto callback_dup = [](ovdl::v2script::ast::ListValue const* ptr, ovdl::v2script::ast::Node const* val) -> bool {
		auto* flat_val = dryad::node_cast<ovdl::v2script::ast::FlatValue>(val);
		std::string_view val_sv = flat_val->value().view();
		CAPTURE(val_sv);
		...
		static auto transformer = [](ranges::common_pair<size_t, ovdl::v2script::ast::Statement const*> pair) -> decltype(pair) {
			pair.first /= 2;
			return pair;
		};
	...
	auto build_list_dup = [&ast](size_t count, auto&& factory) -> ovdl::v2script::ast::ListValue* {
		ovdl::v2script::ast::StatementList slist;
		for (size_t index : ranges::views::iota(static_cast<size_t>(0), count)) {
			std::to_chars_result result = std::to_chars(hex_array.data(), hex_array.data() + hex_array.size(), index);
			CHECK_OR_CONTINUE(result.ec == std::errc {});
		...
		return ast.create<ovdl::v2script::ast::ListValue>(slist);
	};
...
TEST_CASE(
	...
	static auto callback = [](ovdl::v2script::ast::ListValue const* ptr, std::string_view key, ovdl::v2script::ast::Node const* val) -> bool {
		CAPTURE(key);
		auto* flat_val = dryad::node_cast<ovdl::v2script::ast::FlatValue>(val);
		std::string_view val_sv = flat_val->value().view();
		CAPTURE(val_sv);
	...
	static auto length_callback = [](ovdl::v2script::ast::ListValue const* ptr, size_t length) -> size_t {
		auto list = ptr->statements();
