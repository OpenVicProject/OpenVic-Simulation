...
namespace OpenVic {
	...
	public:
		enum struct type_t : uint8_t { VASSAL, UNION, SUBSTATE };
		...
		constexpr SubjectHistory(
			CountryDefinition const& new_overlord, CountryDefinition const& new_subject, const type_t new_subject_type,
