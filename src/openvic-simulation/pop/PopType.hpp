...
namespace OpenVic {
	...
	struct PopType : HasIdentifierAndColour {
		...
		using poptype_weight_map_t = ordered_map<PopType const*, ConditionalWeightFactorAdd>;
		using ideology_weight_map_t = ordered_map<Ideology const*, ConditionalWeightFactorMul>;
