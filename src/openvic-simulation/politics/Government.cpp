...
bool GovernmentTypeManager::add_government_type(
    ...
    bool elections,
    bool appoint_ruling_party,
    Timespan term_duration,
    std::string_view flag_type
) {
	...
	const bool ret = government_types.emplace_item(
	    identifier,
	    index_from_count<GovernmentType::index_t>(get_government_type_count()),
	    identifier,
	    std::move(ideologies),
	    elections,
