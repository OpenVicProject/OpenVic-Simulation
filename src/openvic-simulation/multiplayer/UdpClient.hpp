...
#include "openvic-simulation/multiplayer/HostnameAddress.hpp"
...
namespace OpenVic {
	...
	struct UdpClient : PacketClient {
		...
		NetworkError store_packet(IpAddress p_ip, NetworkSocket::port_type p_port, std::span<uint8_t> p_buf);
	...
	protected:
		...
		NetworkSocket::port_type _peer_port = 0;
