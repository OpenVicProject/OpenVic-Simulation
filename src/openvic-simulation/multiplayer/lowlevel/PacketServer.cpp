...
PacketServer::PacketServer() : _socket { std::make_shared<NetworkSocket>() } {}
...
std::unique_ptr<PacketClient> PacketServer::take_next_client() {
	return take_next_client_as<PacketClient>();
}
