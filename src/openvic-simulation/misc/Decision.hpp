...
namespace OpenVic {
	...
	public:
		...
		Decision(
		    ...
		    ConditionScript&& new_potential,
		    ConditionScript&& new_allow,
		    ConditionalWeightFactorMul&& new_ai_will_do,
		    EffectScript&& new_effect
		);
	...
	public:
		bool add_decision(
		    ...
		    ConditionScript&& potential,
		    ConditionScript&& allow,
		    ConditionalWeightFactorMul&& ai_will_do,
		    EffectScript&& effect
		);
