...
bool DiplomaticActionManager::setup_diplomatic_actions() {
	...
	result &= add_diplomatic_action(
		"request_military_access",
		{
			.commit =
				[](Argument& arg) {
					arg.instance_manager.get_country_relation_manager().set_military_access_to( //
						arg.sender, arg.reciever, true
					);
				},
		}
	...
	result &= add_diplomatic_action(
		"command_units",
		{
			.commit =
				[](Argument& arg) {
					arg.instance_manager.get_country_relation_manager().assign_or_get_commanding_units( //
						arg.sender, arg.reciever
					) = true;
				},
		}
	...
	result &= add_diplomatic_action(
		"discredit",
		{
			...
			.commit =
				[](Argument& arg) {
					arg.instance_manager.get_country_relation_manager().set_is_discredited( //
						arg.sender, arg.reciever, true
					);
				},
		}
	...
	result &= add_diplomatic_action(
		"ban_embassy",
		{
			...
			.commit =
				[](Argument& arg) {
					arg.instance_manager.get_country_relation_manager().set_is_embassy_banned( //
						arg.sender, arg.reciever, true
					);
				},
		}
