...
private:
		...
		RELATION_PAIR_MAP(CountryInstancePair, bool, military_access, military_access_to, const);
		RELATION_PAIR_MAP(CountryInstancePair, bool, war_subsidies, war_subsidies_to, const);
		RELATION_PAIR_MAP(CountryInstancePair, bool, command_units, commanding_units, const);
		...
		RELATION_PAIR_MAP(CountryInstancePair, bool, discredits, is_discredited, const);
		RELATION_PAIR_MAP(CountryInstancePair, bool, embassy_bans, is_embassy_banned, const);
