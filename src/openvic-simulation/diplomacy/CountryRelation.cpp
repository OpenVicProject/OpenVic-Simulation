...
bool CRM::get_military_access_to( //
	CountryInstance const* country, CountryInstance const* recepient
) const {
...
bool& CRM::assign_or_get_military_access_to( //
...
bool CRM::set_military_access_to( //
...
decltype(CRM::military_access)::values_container_type const& CRM::get_military_access_to_values() const {
...
bool& CRM::assign_or_get_commanding_units( //
	CountryInstance* country, CountryInstance const* recepient, bool default_value
) {
...
decltype(CRM::command_units)::values_container_type const& CRM::get_commanding_units_values() const {
...
bool CRM::set_influence_with(CountryInstance* country, CountryInstance const* recepient, influence_value_type value) {
	decltype(influence)::iterator it = influence.find({ country, recepient });
	if (it == influence.end()) {
...
bool& CRM::assign_or_get_is_discredited( //
	CountryInstance* country, CountryInstance const* recepient, bool default_value
) {
...
decltype(CRM::discredits)::values_container_type const& CRM::get_is_discredited_values() const {
	return discredits.values_container();
}

bool CRM::get_is_embassy_banned( //
	CountryInstance const* country, CountryInstance const* recepient
) const {
...
bool& CRM::assign_or_get_is_embassy_banned( //
	CountryInstance* country, CountryInstance const* recepient, bool default_value
) {
...
bool CRM::set_is_embassy_banned( //
	CountryInstance* country, CountryInstance const* recepient, bool value
) {
	decltype(embassy_bans)::iterator it = embassy_bans.find({ country, recepient });
	if (it == embassy_bans.end()) {
...
decltype(CRM::embassy_bans)::values_container_type const& CRM::get_is_embassy_banned_values() const {
