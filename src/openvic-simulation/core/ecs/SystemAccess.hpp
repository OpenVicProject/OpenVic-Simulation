...
namespace OpenVic::ecs {
	...
	inline bool sorted_intersects(std::span<component_type_id_t const> a, std::span<component_type_id_t const> b) {
		std::size_t i = 0;
		std::size_t j = 0;
	...
	inline void merge_extra_reads(std::vector<ComponentAccess>& dest, std::span<component_type_id_t const> extra) {
	...
	inline void merge_extra_writes(std::vector<ComponentAccess>& dest, std::span<component_type_id_t const> extra) {
		for (component_type_id_t id : extra) {
