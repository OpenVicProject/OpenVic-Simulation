...
namespace OpenVic {
	...
	constexpr ordered_map<KeyType, ValueType> operator-(ordered_map<KeyType, ValueType> const& rhs) {
		...
		auto view = rhs | std::views::transform([](KeyType const& key, ValueType const& value) {
	...
	constexpr ordered_map<KeyType, LhsValueType>&
	operator+=(ordered_map<KeyType, LhsValueType>& lhs, ordered_map<KeyType, RhsValueType> const& rhs)
	...
	template<typename KeyType, typename LhsValueType, typename RhsValueType>
	constexpr ordered_map<KeyType, LhsValueType>& operator+=(ordered_map<KeyType, LhsValueType>& lhs, RhsValueType const& rhs)
	requires add_assignable<LhsValueType, RhsValueType>
	{
	...
	constexpr static ValueType get_total(ordered_map<KeyType, ValueType> const& map)
	...
	constexpr static typename ordered_map<KeyType, ValueType>::const_iterator
	get_largest_item(ordered_map<KeyType, ValueType> const& map)
	requires std::three_way_comparable_with<ValueType, ValueType>
	{
		constexpr auto pred = [](typename ordered_map<KeyType, ValueType>::value_type const& lhs,
								 typename ordered_map<KeyType, ValueType>::value_type const& rhs) -> bool {
	...
	template<typename KeyType, typename ValueType>
	constexpr static typename ordered_map<KeyType, ValueType>::const_iterator
	get_largest_item_tie_break(ordered_map<KeyType, ValueType> const& map, const auto key_pred)
	requires std::three_way_comparable_with<ValueType, ValueType>
	{
	...
	constexpr static std::pair<
		typename ordered_map<KeyType, ValueType>::const_iterator, typename ordered_map<KeyType, ValueType>::const_iterator>
	get_largest_two_items(ordered_map<KeyType, ValueType> const& map)
	requires std::three_way_comparable_with<ValueType, ValueType>
	{
