...
namespace OpenVic {
	...
	constexpr ordered_map<KeyType, LhsValueType>& operator+=(
	    ordered_map<KeyType, LhsValueType>& lhs, ordered_map<KeyType, RhsValueType> const& rhs
	)
	...
	constexpr static std::
	    pair<typename ordered_map<KeyType, ValueType>::const_iterator, typename ordered_map<KeyType, ValueType>::const_iterator>
