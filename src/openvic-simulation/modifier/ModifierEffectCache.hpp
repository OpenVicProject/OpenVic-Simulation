...
namespace OpenVic {
	...
	private:
		...
		ModifierEffect const* PROPERTY(artisan_input, nullptr);
		ModifierEffect const* PROPERTY(artisan_output, nullptr);
		ModifierEffect const* PROPERTY(artisan_throughput, nullptr);
		...
		ModifierEffect const* PROPERTY(factory_cost, nullptr);
		ModifierEffect const* PROPERTY(factory_input, nullptr);
		ModifierEffect const* PROPERTY(factory_maintenance, nullptr);
		ModifierEffect const* PROPERTY(factory_output, nullptr);
		ModifierEffect const* PROPERTY(factory_owner_cost, nullptr);
		ModifierEffect const* PROPERTY(factory_throughput, nullptr);
		...
		ModifierEffect const* PROPERTY(mobilisation_economy_impact, nullptr);
		ModifierEffect const* PROPERTY(mobilisation_size, nullptr);
		...
		ModifierEffect const* PROPERTY(rgo_output, nullptr);
		ModifierEffect const* PROPERTY(rgo_throughput, nullptr);
		...
		ModifierEffect const* PROPERTY(suppression_points_modifier, nullptr);
		...
		ModifierEffect const* PROPERTY(war_exhaustion, nullptr);
		...
		ModifierEffect const* PROPERTY(combat_width_percentage_change, nullptr);
		ModifierEffect const* PROPERTY(defence_terrain, nullptr);
