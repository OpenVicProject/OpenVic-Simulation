...
ModifierEffectCache::building_type_effects_t const& ModifierEffectCache::get_building_type_effects(
    BuildingType const& key
) const {
...
ModifierEffectCache::regiment_type_effects_t const& ModifierEffectCache::get_regiment_type_effects(
    RegimentType const& key
) const {
