...
bool StaticModifierCache::load_static_modifiers(ModifierManager& modifier_manager, const ast::NodeCPtr root) {
	...
	#define SET_COUNTRY_MODIFIER2(PROP, _) set_static_country_modifier(PROP);

	// Country modifiers
	COUNTRY_DIFFICULTY_MODIFIER_LIST(SET_COUNTRY_MODIFIER, SET_COUNTRY_MODIFIER2)
	...
	COUNTRY_MODIFIER_LIST(SET_COUNTRY_MODIFIER, SET_COUNTRY_MODIFIER2)

	#undef SET_COUNTRY_MODIFIER
	#undef SET_COUNTRY_MODIFIER2
	...
	#define SET_PROVINCE_MODIFIER2(PROP, _) set_static_province_modifier(PROP);

	// Province modifiers
	PROVINCE_MODIFIER_LIST(SET_PROVINCE_MODIFIER, SET_PROVINCE_MODIFIER2)
