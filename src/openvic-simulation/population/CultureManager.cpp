...
bool CultureManager::_load_culture(
	...
	ovdl::v2script::ast::Node const* culture_node
) {
 ...
 */
bool CultureManager::load_culture_file(CountryDefinitionManager const& country_definition_manager, ovdl::v2script::ast::Node const* root) {
	if (!graphical_culture_types.is_locked()) {
	...
	ret &= expect_culture_group_dictionary(
		[this, &country_definition_manager](CultureGroup const& culture_group, ovdl::v2script::ast::Node const* culture_group_value) -> bool {
			return expect_dictionary(
				[this, &country_definition_manager, &culture_group](std::string_view key, ovdl::v2script::ast::Node const* value) -> bool {
