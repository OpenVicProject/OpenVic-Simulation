...
bool TerrainTypeManager::generate_modifiers(ModifierManager& modifier_manager) const {
	...
	bool ret = true;
	for (TerrainType const& terrain_type : get_terrain_types()) { //not sure how to check these
