...
node_callback_t GraphicsDefines::expect_defines() {
	return expect_dictionary_keys(
	    ...
	    ONE_EXACTLY,
	    expect_uint(assign_variable_callback(cities_sprawl_offset)),
	    "CITIES_SPRAWL_WIDTH",
	    ONE_EXACTLY,
	    expect_uint(assign_variable_callback(cities_sprawl_width)),
	    "CITIES_SPRAWL_HEIGHT",
	    ONE_EXACTLY,
	    expect_uint(assign_variable_callback(cities_sprawl_height)),
	    "CITIES_SPRAWL_ITERATIONS",
	    ONE_EXACTLY,
	    expect_uint(assign_variable_callback(cities_sprawl_iterations)),
	    ...
	    ONE_EXACTLY,
	    expect_uint(assign_variable_callback(cities_mesh_types_count)),
	    "CITIES_MESH_SIZES_COUNT",
	    ONE_EXACTLY,
	    expect_uint(assign_variable_callback(cities_mesh_sizes_count)),
