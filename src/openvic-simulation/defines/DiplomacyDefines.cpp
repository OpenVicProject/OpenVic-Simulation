...
node_callback_t DiplomacyDefines::expect_defines() {
	...
	add_key_map_entries(
	    ...
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(peace_cost_add_to_sphere)),
	    "PEACE_COST_RELEASE_PUPPET",
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(peace_cost_release_puppet)),
	    "PEACE_COST_MAKE_PUPPET",
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(peace_cost_make_puppet)),
	    "PEACE_COST_DISARMAMENT",
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(peace_cost_disarmament)),
	    "PEACE_COST_DESTROY_FORTS",
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(peace_cost_destroy_forts)),
	    ...
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(peace_cost_reparations)),
	    ...
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(peace_cost_remove_cores)),
	    "PEACE_COST_PRESTIGE",
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(peace_cost_prestige)),
	    "PEACE_COST_CONCEDE",
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(peace_cost_concede)),
	    "PEACE_COST_STATUS_QUO",
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(peace_cost_status_quo)),
	    "PEACE_COST_ANNEX",
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(peace_cost_annex)),
	    "PEACE_COST_DEMAND_STATE",
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(peace_cost_demand_state)),
	    ...
	    "PEACE_COST_COLONY",
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(peace_cost_colony)),
	    "INFAMY_ADD_TO_SPHERE",
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(infamy_add_to_sphere)),
	    "INFAMY_RELEASE_PUPPET",
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(infamy_release_puppet)),
	    "INFAMY_MAKE_PUPPET",
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(infamy_make_puppet)),
	    "INFAMY_DISARMAMENT",
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(infamy_disarmament)),
	    "INFAMY_DESTROY_FORTS",
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(infamy_destroy_forts)),
	    "INFAMY_DESTROY_NAVAL_BASES",
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(infamy_destroy_naval_bases)),
	    "INFAMY_REPARATIONS",
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(infamy_reparations)),
	    "INFAMY_TRANSFER_PROVINCES",
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(infamy_transfer_provinces)),
	    "INFAMY_REMOVE_CORES",
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(infamy_remove_cores)),
	    "INFAMY_PRESTIGE",
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(infamy_prestige)),
	    "INFAMY_CONCEDE",
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(infamy_concede)),
	    "INFAMY_STATUS_QUO",
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(infamy_status_quo)),
	    "INFAMY_ANNEX",
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(infamy_annex)),
	    "INFAMY_DEMAND_STATE",
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(infamy_demand_state)),
	    ...
	    "INFAMY_COLONY",
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(infamy_colony)),
	    "PRESTIGE_ADD_TO_SPHERE_BASE",
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(prestige_add_to_sphere_base)),
	    ...
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(prestige_make_puppet_base)),
	    "PRESTIGE_DISARMAMENT_BASE",
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(prestige_disarmament_base)),
	    "PRESTIGE_DESTROY_FORTS_BASE",
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(prestige_destroy_forts_base)),
	    ...
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(prestige_reparations_base)),
	    ...
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(prestige_remove_cores_base)),
	    "PRESTIGE_PRESTIGE_BASE",
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(prestige_prestige_base)),
	    "PRESTIGE_CONCEDE_BASE",
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(prestige_concede_base)),
	    "PRESTIGE_STATUS_QUO_BASE",
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(prestige_status_quo_base)),
	    "PRESTIGE_ANNEX_BASE",
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(prestige_annex_base)),
	    "PRESTIGE_DEMAND_STATE_BASE",
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(prestige_demand_state_base)),
	    ...
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(prestige_gunboat_base)),
	    ...
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(prestige_colony_base)),
	    "PRESTIGE_ADD_TO_SPHERE",
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(prestige_add_to_sphere)),
	    "PRESTIGE_RELEASE_PUPPET",
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(prestige_release_puppet)),
	    "PRESTIGE_MAKE_PUPPET",
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(prestige_make_puppet)),
	    "PRESTIGE_DISARMAMENT",
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(prestige_disarmament)),
	    "PRESTIGE_DESTROY_FORTS",
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(prestige_destroy_forts)),
	    ...
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(prestige_transfer_provinces)),
	    "PRESTIGE_REMOVE_CORES",
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(prestige_remove_cores)),
	    "PRESTIGE_PRESTIGE",
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(prestige_prestige)),
	    "PRESTIGE_CONCEDE",
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(prestige_concede)),
	    "PRESTIGE_STATUS_QUO",
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(prestige_status_quo)),
	    "PRESTIGE_ANNEX",
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(prestige_annex)),
	    "PRESTIGE_DEMAND_STATE",
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(prestige_demand_state)),
	    "PRESTIGE_CLEAR_UNION_SPHERE",
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(prestige_clear_union_sphere)),
	    "PRESTIGE_GUNBOAT",
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(prestige_gunboat)),
	    ...
	    "PRESTIGE_COLONY",
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(prestige_colony)),
	    ...
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(breaktruce_infamy_prestige)),
	    "BREAKTRUCE_INFAMY_CONCEDE",
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(breaktruce_infamy_concede)),
	    ...
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(breaktruce_infamy_annex)),
	    ...
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(breaktruce_infamy_colony)),
	    ...
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(breaktruce_prestige_concede)),
	    ...
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(breaktruce_prestige_annex)),
	    ...
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(breaktruce_prestige_colony)),
	    ...
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(breaktruce_militancy_annex)),
	    ...
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(breaktruce_militancy_colony)),
	    ...
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(goodrelation_infamy_concede)),
	    ...
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(goodrelation_infamy_annex)),
	    ...
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(goodrelation_infamy_colony)),
	    ...
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(goodrelation_prestige_annex)),
	...
	add_key_map_entries(
	    ...
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(war_prestige_cost_base)),
	    ...
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(war_prestige_cost_truce)),
	    ...
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(war_prestige_cost_core)),
	    "WAR_FAILED_GOAL_MILITANCY",
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(war_failed_goal_militancy)),
	    ...
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(war_failed_goal_prestige)),
	    "DISCREDIT_DAYS",
	    ONE_EXACTLY,
	    expect_days(assign_variable_callback(discredit_days)),
	    ...
	    "BANEMBASSY_DAYS",
	    ONE_EXACTLY,
	    expect_days(assign_variable_callback(banembassy_days)),
	    ...
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(declarewar_diplomatic_cost)),
	    ...
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(addwargoal_diplomatic_cost)),
	    "ADD_UNJUSTIFIED_GOAL_BADBOY",
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(add_unjustified_goal_badboy)),
	    "PEACE_RELATION_ON_ACCEPT",
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(peace_relation_on_accept)),
	    "PEACE_RELATION_ON_DECLINE",
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(peace_relation_on_decline)),
	    "PEACE_DIPLOMATIC_COST",
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(peace_diplomatic_cost)),
	    "ALLIANCE_RELATION_ON_ACCEPT",
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(alliance_relation_on_accept)),
	    ...
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(alliance_diplomatic_cost)),
	    ...
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(callally_relation_on_accept)),
	    ...
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(callally_diplomatic_cost)),
	    ...
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(warsubsidy_diplomatic_cost)),
	    ...
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(discredit_influence_cost)),
	    ...
	    ONE_OR_MORE, // Appears twice in vanilla!
	    ...
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(banembassy_influence_cost)),
	    ...
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(addtosphere_influence_cost)),
	    ...
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(make_cb_diplomatic_cost)),
	    "MAKE_CB_RELATION_ON_ACCEPT",
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(make_cb_relation_on_accept)),
	    "DISARMAMENT_ARMY_HIT",
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(disarmed_penalty)),
	    "REPARATIONS_TAX_HIT",
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(reparations_tax_hit)),
	    "PRESTIGE_REDUCTION_BASE",
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(prestige_reduction_base)),
	    "PRESTIGE_REDUCTION",
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(prestige_reduction)),
	    "REPARATIONS_YEARS",
	    ONE_EXACTLY,
	    expect_years(assign_variable_callback(reparations_duration)),
	    "MIN_WARSCORE_TO_INTERVENE",
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(min_warscore_to_intervene)),
	    "MIN_MONTHS_TO_INTERVENE",
	    ONE_EXACTLY,
	    expect_months(assign_variable_callback(min_time_to_intervene)),
	    "MAX_WARSCORE_FROM_BATTLES",
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(max_warscore_from_battles)),
	    "GUNBOAT_DIPLOMATIC_COST",
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(gunboat_diplomatic_cost)),
	    "GUNBOAT_RELATION_ON_ACCEPT",
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(gunboat_relation_on_accept)),
	    ...
	    "BASE_TRUCE_MONTHS",
	    ONE_EXACTLY,
	    expect_months(assign_variable_callback(base_truce_duration)),
	    "MAX_INFLUENCE",
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(max_influence)),
	    "WARSUBSIDIES_PERCENT",
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(warsubsidies_percent)),
	    ...
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(release_nation_prestige)),
	    "RELEASE_NATION_INFAMY",
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(release_nation_infamy)),
	    "INFAMY_CLEAR_UNION_SPHERE",
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(infamy_clear_union_sphere)),
	    ...
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(good_peace_refusal_warexh)),
	    "PEACE_COST_GUNBOAT",
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(peace_cost_gunboat)),
	    "INFAMY_GUNBOAT",
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(infamy_gunboat)),
	    "BREAKTRUCE_INFAMY_GUNBOAT",
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(breaktruce_infamy_gunboat)),
	    "BREAKTRUCE_PRESTIGE_GUNBOAT",
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(breaktruce_prestige_gunboat)),
	    ...
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(goodrelation_infamy_gunboat)),
	    ...
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(cb_generation_base_speed)),
	    ...
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(make_cb_relation_limit)),
	    "CB_DETECTION_CHANCE_BASE",
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(cb_detection_chance_base)),
	    ...
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(relation_influence_modifier)),
	    ...
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(gw_intervene_min_relations)),
	    ...
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(gw_justify_cb_badboy_impact)),
	    "GW_CB_CONSTRUCTION_SPEED",
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(gw_cb_construction_speed)),
	    ...
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(gw_warscore_cost_mod)),
	    "GW_WARSCORE_COST_MOD_2",
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(gw_warscore_cost_mod_2)),
	    "GW_WARSCORE_2_THRESHOLD",
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(gw_warscore_2_threshold)),
	    "TENSION_DECAY",
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(tension_decay)),
	    "TENSION_FROM_CB",
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(tension_from_cb)),
	    "TENSION_FROM_MOVEMENT",
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(tension_from_movement)),
	    "TENSION_FROM_MOVEMENT_MAX",
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(tension_from_movement_max)),
	    "AT_WAR_TENSION_DECAY",
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(at_war_tension_decay)),
	    "TENSION_ON_CB_DISCOVERED",
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(tension_on_cb_discovered)),
	    "TENSION_ON_REVOLT",
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(tension_on_revolt)),
	    "TENSION_WHILE_CRISIS",
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(tension_while_crisis)),
	    "CRISIS_COOLDOWN_MONTHS",
	    ONE_EXACTLY,
	    expect_months(assign_variable_callback(crisis_cooldown_duration)),
	    "CRISIS_BASE_CHANCE",
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(crisis_base_chance)),
	    "CRISIS_TEMPERATURE_INCREASE",
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(crisis_temperature_increase)),
	    ...
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(back_crisis_diplomatic_cost)),
	    ...
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(crisis_wargoal_infamy_mult)),
	    ...
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(rank_1_tension_decay)),
	    "RANK_2_TENSION_DECAY",
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(rank_2_tension_decay)),
	    "RANK_3_TENSION_DECAY",
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(rank_3_tension_decay)),
	    "RANK_4_TENSION_DECAY",
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(rank_4_tension_decay)),
	    "RANK_5_TENSION_DECAY",
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(rank_5_tension_decay)),
	    "RANK_6_TENSION_DECAY",
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(rank_6_tension_decay)),
	    "RANK_7_TENSION_DECAY",
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(rank_7_tension_decay)),
	    "RANK_8_TENSION_DECAY",
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(rank_8_tension_decay)),
	    "TWS_FULFILLED_SPEED",
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(tws_fulfilled_speed)),
	    "TWS_NOT_FULFILLED_SPEED",
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(tws_not_fulfilled_speed)),
	    "TWS_GRACE_PERIOD_DAYS",
	    ONE_EXACTLY,
	    expect_days(assign_variable_callback(tws_grace_period_days)),
	    "TWS_CB_LIMIT_DEFAULT",
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(tws_cb_limit_default)),
	    "TWS_FULFILLED_IDLE_SPACE",
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(tws_fulfilled_idle_space)),
	    "TWS_BATTLE_MIN_COUNT",
	    ONE_EXACTLY,
	    expect_uint(assign_variable_callback(tws_battle_min_count)),
	    "TWS_BATTLE_MAX_ASPECT",
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(tws_battle_max_aspect)),
	    ...
	    ONE_EXACTLY,
	    expect_fixed_point(assign_variable_callback(lone_backer_prestige_factor))
	);
