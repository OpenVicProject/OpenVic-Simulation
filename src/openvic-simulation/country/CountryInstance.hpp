...
namespace OpenVic {
	...
	struct CountryInstance : CountryEconomy, FlagStrings, HasIndex<CountryInstance>, PopsAggregate {
	...
	public:
		...
		fixed_point_t get_modifier_effect_value(ModifierEffect const& effect) const override;
		fixed_point_t get_yesterdays_import_value(DependencyTracker& tracker) override;
