...
CountryParty::CountryParty(
	...
	: HasIdentifierAndColour { new_identifier,
							   new_ideology != nullptr ? new_ideology->get_colour() : Ideology::NO_IDEOLOGY_COLOUR, false },
	  start_date { new_start_date }, end_date { new_end_date }, ideology { new_ideology },
