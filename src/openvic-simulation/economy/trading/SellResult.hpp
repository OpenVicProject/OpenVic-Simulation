...
namespace OpenVic {
	...
	public:
		...
		constexpr SellResult(
			GoodDefinition const& new_good_definition, const fixed_point_t new_quantity_sold,
			const fixed_point_t new_money_gained
		)
			: good_definition { new_good_definition }, quantity_sold { new_quantity_sold }, money_gained { new_money_gained } {}
