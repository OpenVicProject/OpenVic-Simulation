...
namespace OpenVic {
	...
	public:
		constexpr MarketInstance(
			ThreadPool& new_thread_pool, CountryDefines const& new_country_defines,
		...
		fixed_point_t
		get_max_money_to_allocate_to_buy_quantity(GoodDefinition const& good_definition, const fixed_point_t quantity) const;
