...
namespace OpenVic {
	...
	public:
		...
		constexpr GoodBuyUpToOrder(
			const std::optional<country_index_t> new_country_index_optional, const fixed_point_t new_max_quantity,
			const fixed_point_t new_money_to_spend, const actor_t new_actor, const callback_t new_after_trade
		)
			: country_index_optional { new_country_index_optional }, max_quantity { new_max_quantity },
			  money_to_spend { new_money_to_spend }, actor { new_actor }, after_trade { new_after_trade } {}
	...
	public:
		...
		constexpr BuyUpToOrder(
			...
			const fixed_point_t new_max_quantity, const fixed_point_t new_money_to_spend, const actor_t new_actor,
			const callback_t new_after_trade
		)
			: GoodBuyUpToOrder { new_country_index_optional, new_max_quantity, new_money_to_spend, new_actor, new_after_trade },
			  good { new_good } {}
