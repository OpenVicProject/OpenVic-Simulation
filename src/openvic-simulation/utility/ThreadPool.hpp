...
namespace OpenVic {
	...
	public:
		...
		WorkBundle(
			RandomU32::state_type rng_state, forwardable_span<CountryInstance> new_countries_chunk,
			forwardable_span<GoodInstance> new_goods_chunk, forwardable_span<ProvinceInstance> new_provinces_chunk
		)
			: random_number_generator { rng_state }, countries_chunk { new_countries_chunk }, goods_chunk { new_goods_chunk },
