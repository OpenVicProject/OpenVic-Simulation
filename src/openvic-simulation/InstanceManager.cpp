...
InstanceManager::InstanceManager(
    ...
    good_instance_manager {
	    new_definition_manager.get_economy_manager().get_good_definition_manager(), new_game_rules_manager
    },
    ...
    country_instance_deps {
	    ...
	    new_definition_manager.get_modifier_manager().get_modifier_effect_cache(),
	    PopsAggregateDeps {
	        ideology_index_t(new_definition_manager.get_politics_manager().get_ideology_manager().get_ideology_count()),
	        party_policy_index_t(new_definition_manager.get_politics_manager().get_issue_manager().get_party_policy_count()),
	        pop_type_index_t(new_definition_manager.get_pop_manager().get_pop_type_count()),
	        reform_index_t(new_definition_manager.get_politics_manager().get_issue_manager().get_reform_count()),
	        strata_index_t(new_definition_manager.get_pop_manager().get_strata_count()) },
    ...
    pop_deps { artisanal_producer_deps, market_instance, pops_aggregate_deps },
    rgo_deps { market_instance,
	           new_definition_manager.get_modifier_manager().get_modifier_effect_cache(),
	           pop_type_index_t(new_definition_manager.get_pop_manager().get_pop_type_count()) },
    ...
    politics_instance_manager { *this, new_definition_manager.get_politics_manager().get_ideology_manager().get_ideologies() },
    map_instance { new_definition_manager.get_map_definition(), province_instance_deps, thread_pool }, simulation_clock {
	    [this]() -> void {
...
bool InstanceManager::load_bookmark(Bookmark const& new_bookmark) {
	...
	bool ret = map_instance.apply_history_to_provinces(
	    definition_manager.get_history_manager().get_province_manager(),
	    today,
	    country_instance_manager,
